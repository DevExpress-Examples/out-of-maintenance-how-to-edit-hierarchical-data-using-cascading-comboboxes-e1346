...
namespace MultiCombo
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void Cat2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ASPxComboBox combo3 = ((ASPxComboBox)ASPxGridView1.FindEditFormTemplateControl("Cat3"));
            combo3.Value = null;
        ...
        protected void Cat3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ASPxComboBox combo4 = ((ASPxComboBox)ASPxGridView1.FindEditFormTemplateControl("Cat4"));
            combo4.Value = null;
        }
        ...
        protected void ASPxGridView1_HtmlEditFormCreated(object sender, DevExpress.Web.ASPxGridViewEditFormEventArgs e)
        {
            ...
            {
                object[] vals = (object[])ASPxGridView1.GetRowValues(ASPxGridView1.EditingRowVisibleIndex,
        ...
        {
            object[] vals = (object[]) ASPxGridView1.GetRowValuesByKeyValue(e.EditingKeyValue, 
        ...
        {
            object cat1 = ((ASPxComboBox)ASPxGridView1.FindEditFormTemplateControl("Cat1")).Value;
            NewValues["Category1ID"] = cat1;
            object cat2 = ((ASPxComboBox)ASPxGridView1.FindEditFormTemplateControl("Cat2")).Value;
            NewValues["Category2ID"] = cat2;
            object cat3 = ((ASPxComboBox)ASPxGridView1.FindEditFormTemplateControl("Cat3")).Value;
            NewValues["Category3ID"] = cat3;
            object cat4 = ((ASPxComboBox)ASPxGridView1.FindEditFormTemplateControl("Cat4")).Value;
