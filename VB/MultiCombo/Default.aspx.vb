...
Namespace MultiCombo
	Partial Public Class _Default
		...
		Private sources As Dictionary(Of ASPxComboBox, SqlDataSource) = New Dictionary(Of ASPxComboBox, SqlDataSource)()
		...
		Protected Sub Cat2_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim combo3 As ASPxComboBox = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat3"), ASPxComboBox))
		...
		Protected Sub Cat3_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim combo4 As ASPxComboBox = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat4"), ASPxComboBox))
		...
		Protected Sub ASPxGridView1_HtmlEditFormCreated(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewEditFormEventArgs)
			...
			If (Not ASPxGridView1.IsNewRowEditing) Then
				Dim vals() As Object = CType(ASPxGridView1.GetRowValues(ASPxGridView1.EditingRowVisibleIndex, New String() { "Category2ID", "Category3ID", "Category4ID" }), Object())
				Dim combo4 As ASPxComboBox = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat4"), ASPxComboBox))
				Dim combo3 As ASPxComboBox = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat3"), ASPxComboBox))
				combo2.Value = vals(0)
				combo3.Value = vals(1)
		...
		Protected Sub ASPxGridView1_StartRowEditing(ByVal sender As Object, ByVal e As DevExpress.Web.Data.ASPxStartRowEditingEventArgs)
			Dim vals() As Object = CType(ASPxGridView1.GetRowValuesByKeyValue(e.EditingKeyValue, New String() {"Category1ID", "Category2ID", "Category3ID" }), Object())
		...
		Private Sub SaveOrInsertData(ByVal NewValues As OrderedDictionary)
			Dim cat1 As Object = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat1"), ASPxComboBox)).Value
			NewValues("Category1ID") = cat1
			Dim cat2 As Object = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat2"), ASPxComboBox)).Value
			NewValues("Category2ID") = cat2
			Dim cat3 As Object = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat3"), ASPxComboBox)).Value
			NewValues("Category3ID") = cat3
			Dim cat4 As Object = (CType(ASPxGridView1.FindEditFormTemplateControl("Cat4"), ASPxComboBox)).Value
